...
int main(void) {
    ...
    int graph_sizes[] = {100, 200, 500, 1000, 2000, 5000}; //in case you are testing, 10k and 20k will lead to long waiting time.
    //int graph_sizes[] = {10000};
    //int graph_sizes[] = {20000};
    for (int i = 0; i < sizeof(graph_sizes) / sizeof(int); ++i) {
        ...
        free_nodesArray(pg->nodesarray);
        freePathMatrix(pg->pathmatrix);
        free(pg);
